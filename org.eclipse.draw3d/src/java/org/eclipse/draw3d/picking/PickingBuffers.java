...
public interface PickingBuffers {
	...
	/**
	 * Returns a snaptshot of these picking buffers.
	 * 
	 * @return a snapshot of these picking buffers
	 */
	 ...
	 * @throws IllegalStateException if the offscreen renderer is not
	 *             initialized or disposed
	 */
	public abstract ByteBuffer getColorBuffer();
	 ...
	 *             initialized or disposed
	 */
	public abstract FloatBuffer getDepthBuffer();
	 ...
	 * 
	 * @param i_rootFigure the root figure to paint
	 * @param i_figureManager the figure manager
	 * @param i_canvas the gl canvas to paint on
	 */
	public abstract void repaint(final IFigure i_rootFigure,
