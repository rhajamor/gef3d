...
public class Draw3DFontInfo {
	 ...
	 */
	public Draw3DFontInfo(Font i_font, boolean i_antialiased) {
	 ...
	 * @param i_antialiased whether the font is antialiased
	 */
	public Draw3DFontInfo(String i_name, int i_height, boolean i_bold,
	...
	public boolean equals(Object i_obj) {
		...
		if (!(i_obj instanceof Draw3DFontInfo))
			return false;

		Draw3DFontInfo info = (Draw3DFontInfo) i_obj;
