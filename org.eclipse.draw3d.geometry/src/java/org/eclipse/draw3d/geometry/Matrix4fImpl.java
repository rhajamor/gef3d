...
public class Matrix4fImpl implements Matrix4f, Serializable, Cloneable {
     ...
     *            Values are read from this array
     ...
     *            the matrix is stored in column major (OpenGL) format
     * @param i_iOffset
     *            Get values from array with this offset.
     */
    public Matrix4fImpl(final float[] i_arrayOfFloat,
    ...
    public boolean equals(final IMatrix4f i_anotherMatrix4f) {
        ...
        return a11 == sm.a11
                ...
                && a14 == sm.a14
                && // 
                a21 == sm.a21 && a22 == sm.a22
                && a23 == sm.a23
                && a24 == sm.a24
                && //
                a31 == sm.a31 && a32 == sm.a32 && a33 == sm.a33
                && a34 == sm.a34
                && //
                a41 == sm.a41 && a42 == sm.a42 && a43 == sm.a43
                && a44 == sm.a44;
    }
