...
public class Math3DMatrixOps extends Math3DMatrix4f {
     ...
     *             if the given vector is <code>null</code>
     ...
     * @param o_result
     *            the result matrix, if <code>null</code>, a new matrix will be
     *            returned
    ...
    public static Matrix4f rotate(IVector3f i_angles, IMatrix4f i_matrix,
        ...
        if (yAngle != 0)
            Math3D.rotate(yAngle, IVector3f.Y_AXIS, i_matrix, o_result);

        float zAngle = i_angles.getZ();
        if (zAngle != 0)
            Math3D.rotate(zAngle, IVector3f.Z_AXIS, i_matrix, o_result);

        float xAngle = i_angles.getX();
        if (xAngle != 0)
            Math3D.rotate(xAngle, IVector3f.X_AXIS, i_matrix, o_result);
     ...
     * 
     * @param i_vector
     *            the vector to transform, in cartesian coordinates
     * @param i_matrix
     *            the transformation matrix, in cartesian coordinates
     * @param o_result
     *            the result vector, if <code>null</code>, a new vector will be
     *            returned
     ...
     * 
     * @param i_source
     *            the matrix to be translated, in homogeneous coordinates
     * @param i_vector
