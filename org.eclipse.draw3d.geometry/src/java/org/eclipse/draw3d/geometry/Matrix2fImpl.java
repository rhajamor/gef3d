...
public class Matrix2fImpl implements Matrix2f, Serializable, Cloneable {
	 ...
	 *            format
	 */
	public Matrix2fImpl(final float a, final float b, final float c, final float d, boolean i_bColumnMajor) {
		if (!i_bColumnMajor) {
			a11 = a;
			a12 = b;
			a21 = c;
	 ...
	 * <code>i_bColumnMajor</code>.
	 * 
	 * @param i_floats, not null and i_floats.size()+i_iOffset >= 4 must be true
	 * @param i_bColumnMajor the matrix is stored in column major (OpenGL)
	 *            format
