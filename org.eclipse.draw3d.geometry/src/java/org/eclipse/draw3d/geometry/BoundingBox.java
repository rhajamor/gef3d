...
public interface BoundingBox extends IBoundingBox, Transformable {
     ...
     * 
     * @param i_delta
     *            the value to expand the box by
     */
     ...
     * 
     * @param i_dx
     *            add this value to the X dimension of this bounding box
     * @param i_dy
     *            add this value to the Y dimension of this bounding box
     * @param i_dz
     *            add this value to the Z dimension of this bounding box
     */
     ...
     * 
     * @param i_deltaVector3f
     *            the vector to add to the dimensions of this bounding box
     */
     ...
     * 
     * @param i_dx
     *            add this to the X coordinate
     * @param i_dy
     *            add this to the Y coordinate
     * @param i_dz
     *            add this to the Z coordinate
     */
