...
/**
 * Generic immutable matrix interface for converting a matrix 
 * into arrays of buffers.
 * 
...
public interface IMatrix {
	/**
	 * Stores the entries of the matrix into an array, starting at offset 0, 
	...
	/**
	 * Stores the entries of the matrix into an array, starting at offset
	 * 0, in row major order.
	 * 
	 * @param buf The buffer to store it in, at the current position
	 */
	 ...
	 * code: The entries of the structure are converted into an array (row major), and then
