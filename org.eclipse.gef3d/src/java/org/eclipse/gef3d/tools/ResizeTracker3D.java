...
public class ResizeTracker3D extends ResizeTracker {
     ...
     */
    private static final Logger log = Logger.getLogger(ResizeTracker3D.class.getName());
    ...
    protected Point getLocation() {
        ...
        return new Point(getTrackState().getCurrentSurfaceLocation());
    }
    ...
    protected Point getStartLocation() {
        ...
        return new Point(getTrackState().getInitialSurfaceLocation());
    }

    /**
     * Updates the current dragstate with the current drag location and returns
     * it. If the drag has just begun, a new trackstate will be created.
     * 
     * @return the updated track state
     */
    ...
    protected void updateSourceRequest() {
        ...
        if (request instanceof ChangeBounds3DRequest) {
            ...
            Vector3f moveDelta3D = getTrackState().getWorldMoveDelta();
            IVector3f location3D = new Vector3fImpl(
                getTrackState().getInitialWorldLocation());
            ...
            log.warning("3D coordinates of request not set, wrong type: " + request); //$NON-NLS-1$
        }
    }
}
