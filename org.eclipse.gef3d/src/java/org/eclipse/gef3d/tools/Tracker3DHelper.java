...
public class Tracker3DHelper {
	 ...
	 * @return the picker for the given viewer or <code>null</code> if there
	 *         is no picker for the given viewer
	 ...
	 * 
	 * @param i_viewer the edit part viewer
	 * @return the picking update manager or <code>null</code> if the given
	 *         edit part viewer doesn't have one
	 * @throws NullPointerException if the given viewer is <code>null</code>
	 */
