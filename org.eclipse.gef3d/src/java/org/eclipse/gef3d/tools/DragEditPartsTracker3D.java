...
public class DragEditPartsTracker3D extends DragEditPartsTracker {
    ...
    protected Dimension getDragMoveDelta() {
        ...
        return new Dimension(getTrackState().getSurfaceMoveDelta());
    }
    ...
    protected TrackState getTrackState() {
        ...
        if (m_trackState == null) {
            ...
            m_trackState = Tracker3DHelper.getTrackState(
                super.getStartLocation(), getCurrentViewer());
        } else
            m_trackState.update(getCurrentInput().getMouseLocation());
    ...
    protected void updateTargetRequest() {
        ...
        if (request1 instanceof ChangeBounds3DRequest) {
            ...
            IVector3f delta = new Vector3fImpl(
                getTrackState().getWorldMoveDelta());
