...
/**
 * {@link INestableEditor} using the same {@link EditingDomain} as its nesting
 * multi editor.
 * <p>
...
public interface INestableEditorWithEditingDomain extends INestableEditor {
	 ...
	 * order to share the same resource set in all nested editors. In
	 * DiagramDocumentEditor#createEditingDomain(), a new editing domain is
	 * created on the fly. However, this also happens in
	 * {@link DiagramDocumentEditor#doSetInput(org.eclipse.ui.IEditorInput, boolean)}
	 ...
	 * {@link org.eclipse.gmf.runtime.diagram.ui.resources.editor.parts.DiagramDocumentEditor#getEditingDomainID()}
