...
public class AbstractPosition3DTest {
	...
	/**
	 * Test method for {@link org.eclipse.draw3d.geometry.AbstractPosition3D#getAbsolute(org.eclipse.draw3d.geometry.Position3D)}.
	 */
	@Test
	public void testGetAbsolute() {
		Position3D parent = Position3DUtil.createAbsolutePosition();
		Position3D pos = Position3DUtil.createRelativePosition(parent.getHost());
