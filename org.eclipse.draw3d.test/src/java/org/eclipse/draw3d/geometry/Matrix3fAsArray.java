...
public class Matrix3fAsArray implements Matrix3f, Serializable, Cloneable {
	...
	public Matrix3fAsArray() {
		afloat = new float[9]; // all values are initialized with 0f, see Java Spec
		afloat[0] = 1;
		afloat[4] = 1;
		afloat[8] = 1;
	}
	...
	/**
	 * Creates this matrix and sets its values to the values of the given 
	 * float array, the matrix is optionally transposed.
	 * The array size must be equal or greater 9.
	 * 
	 ...
	 * Creates this matrix and sets its values to the values of the given 
	 * float array, the matrix is optionally transposed.
	 * The array size must be equal or greater 9+i_iOffset.
	 * 
...
//	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.draw3d.geometry.IMatrix3f#toArrayColumnMajor(float[], int)
	 */
